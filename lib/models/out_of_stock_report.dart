class OutOfStockReportResponse {
  final bool success;
  final String message;
  final OutOfStockReportData? data;

  OutOfStockReportResponse({
    required this.success,
    required this.message,
    this.data,
  });

  factory OutOfStockReportResponse.fromJson(Map<String, dynamic> json) {
    return OutOfStockReportResponse(
      success: json['success'] as bool? ?? false,
      message: json['message'] as String? ?? '',
      data: json['data'] != null ? OutOfStockReportData.fromJson(json['data'] as Map<String, dynamic>) : null,
    );
  }
...
class OutOfStockReportData {
  ...
  factory OutOfStockReportData.fromJson(Map<String, dynamic> json) {
    return OutOfStockReportData(
      id: json['id'] as int? ?? 0,
    );
  }
...
class OutOfStockProduct {
  final int productId;
  final int actualQty;
  final int estimatedPo;
  final int averageWeeklySaleOut;
  final int averageWeeklySaleIn;
  final int oosDistributor;

  OutOfStockProduct({
    required this.productId,
    required this.actualQty,
    required this.estimatedPo,
    required this.averageWeeklySaleOut,
    required this.averageWeeklySaleIn,
    required this.oosDistributor,
  });
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'estimated_po': estimatedPo,
      'average_weekly_sale_out': averageWeeklySaleOut,
      'average_weekly_sale_in': averageWeeklySaleIn,
      'oos_distributor': oosDistributor,
    };
  }
}

// Reuse Product model from expired_date_report.dart
class Product {
  final int id;
  final String code;
  final String name;
